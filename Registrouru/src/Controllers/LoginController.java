...
public class LoginController {
	...
	public static String Login (HttpServletRequest request) {
		...
		if(Auth.AuthCheck(request.getParameter("user"), request.getParameter("pass"))) {						
			...
			//chequea si el usuario que se esta logeando tiene o no foto de perfil
			if(		(FileCheck.Check(UserSession)).equals(UserSession+".jpg")		)sesion.setAttribute("foto", UserSession+".jpg");
			else if (	(FileCheck.Check(UserSession)).equals(UserSession+".png")	)sesion.setAttribute("foto", UserSession+".jpg");
			else sesion.setAttribute("foto", "unchecked");
			
			System.out.println(sesion.getAttribute("foto"));
