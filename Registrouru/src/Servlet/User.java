...
public class User extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String titulo = request.getParameter("NameFile");
		
		
		
		if(titulo.equals(""))out.print("Nombre invalido");
		else out.print(		UploadVideo.Upload(request.getPart("InputFile"), request.getParameter("NameFile"))		);
